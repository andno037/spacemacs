...
values."
  (setq-default
   ...
   '(
     ...
     shell
     eshell
     (ycmd :variables ycmd-server-command '("junest python" "/home/adde/Downloads/ycmd/ycmd"))
     )
 ...
 '(projectile-other-file-alist
   (quote
    (("cpp" "h" "hpp" "ipp")
     ...
     ("m" "h")
     ("mm" "h")
     ("h" "c" "cpp" "ipp" "hpp" "cxx" "ixx" "hxx" "m" "mm" "cc")
     ("cc" "hh" "hpp" "h")
     ("hh" "cc")
     ("vert" "frag")
     ("frag" "vert")
     ...
     ("lock" "")
     ("gpg" ""))))
 '(safe-local-variable-values (quote ((helm-make-build-dir "test/gtest/bin/")))))
(custom-set-faces
